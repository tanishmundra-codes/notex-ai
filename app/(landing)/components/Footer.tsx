      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6 leading-relaxed">
              Transforming how students understand and learn from their study materials.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-zinc-100 dark:border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="https://x.com/tanishshh" target="_blank" className="text-zinc-400 hover:text-zinc-950 dark:hover:text-white transition-colors">
              <Twitter className="w-5 h-5" />
            </Link>
            <Link href="https://github.com/tanishmundra-codes" target="_blank" className="text-zinc-400 hover:text-zinc-950 dark:hover:text-white transition-colors">
              <Github className="w-5 h-5" />
            </Link>
            <Link href="https://www.linkedin.com/in/tanish-mundra/" target="_blank" className="text-zinc-400 hover:text-zinc-950 dark:hover:text-white transition-colors">
